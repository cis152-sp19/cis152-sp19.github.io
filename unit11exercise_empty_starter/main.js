...
//#6c
console.log("The answer is: "+((49+89)*3/(72-36)));
...
//#7d
console.log("The type of 'two' is: "+ typeof(2));

//#7e
console.log("The type of 'new Date' is: "+ typeof("new Date"));

//#7f errors are unavoidable from this point fowards. It will not process the variables that are determined to be commands. As such all commands of that nature will be comments.
...
//#8f
console.log ("The final total is: XX, when starting values are 'foo':YYYY and 'bar':ZZZ");
